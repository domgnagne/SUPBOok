...
<html>
    <script>
        function buttonInvite()
        {
            ...
            window.open('mailto:' + document.getElementById("champsIdBooster").value + '?subject=Invitation&body=Hello tu veux nous rejoindre.');
            document.getElementById("champsIdBooster").value = "";
            alert('Invitation send successfully to ' + document.getElementById("champsIdBooster").value + "@supinfo.com");
    ...
    <body>
        ...
        <form>
            <label>ID booster</lable>
                <input id="champsIdBooster" type="number"/> 
                <button onclick="buttonInvite()" type="button">Send invitation</button>
        </form>
    </body>
</html>